...
import 'package:flutter_tcp_test/MultiAppDataList.dart';
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: GestureDetector(
                                      ...
                                      child: SvgPicture.asset('assets/lung.svg', height: 50, ))
                                  )
                              ],
                       )))
                  ],
                       ...
                       return ListView.builder(
                         shrinkWrap: true,
                          ...
                          // Util.log.e(c.toString());
                            var multiAppData = message2201!.multiAppDatas![index];
                           // var multiAppData = c['multiAppDatas'][index];
                            //final roomInfos = c['multiAppDatas'][index]['RoomInfos'];
                           // final roomCount = c['multiAppDatas'][index]['roomcount'];
                            //Util.log.e(c['multiAppDatas'][index]['multiAppUUID'].runtimeType);

                           // Util.log.e(multiAppData.runtimeType);
                           // Util.log.e(multiAppData);
                            // Util.log.e(multiAppData.toString());
                            // Map<String, dynamic> MultiAppData = jsonDecode(multiAppData);
                            return MultiAppDataList(data: multiAppData.toJson());
                          }
                       );}
                    }
                  }
